...
export const events: Event[] = [
  // Main Stage Events
  {
    ...
    description: "Official inauguration of Eventsphere 2026 with special performances and guest speeches.",
    date: "May 15, 2026",
  ...
  // Open Air Events
  {
    ...
    description: "College bands compete for the title of Eventsphere 2026 Best Band with original compositions.",
    date: "May 15, 2026",
